...
def displayAnswerOptions():
    global center_frame
    print(questionAnswerList[questionIndex].type)
    if questionAnswerList[questionIndex].type in ["shortAnswer", "askUserName"]:
        tk.Entry(center_frame, textvariable=guessLabel, width=20, font=(font, 14)).pack(pady=10)
        print("Entry box")
    elif questionAnswerList[questionIndex].type == "multipleChoice":
        tk.Entry(center_frame, textvariable=guessLabel, width=20, font=(font, 14)).pack(pady=10)
        print("Multiple radio buttons")
    elif questionAnswerList[questionIndex].type == "trueFalse":
        tk.Entry(center_frame, textvariable=guessLabel, width=20, font=(font, 14)).pack(pady=10)
        print("Two radio button")
...
def poser_question():
    ...
    # if (questionAnswerList[questionIndex + 1].type) == "trueFalse"
...
def check_answer(event=None):
    ...
    if questionAnswerList[questionIndex].type == "askUserName":
...
def setupUI():
    ...
    '''
    tk.Label(center_frame, text="Devine la figure géométrique!", font=(font, 22), bg="#123456", fg="white").pack(
        pady=10)
...
# Génère la liste des questions/réponses/type
